...
| **M3E-6G → M3E-6L** | Ratified activation prerequisite slices | 6G persistence safety · 6H static AgentProfile config · 6I-a shared pure live-plan predicate (these three independently actionable) → **Product Decision gate** (trigger, authorized Actor/Project scope, supported receiver capability set) → 6I-b post-wait context contract → 6J explicit caller preparation → 6K receiver seam + exact-run terminalization → 6L offline activation acceptance; 6J must not precede 6I-b; live activation needs separate strict approval |
