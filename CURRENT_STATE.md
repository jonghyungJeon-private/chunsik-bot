...
- **Product identity migration:** Quoky Platform (`Quoky`), workspace `@quoky/*`, application
  `apps/quoky`, root package `quoky-platform`. ADR-0086 is **Proposed**, pending independent review
  and Chief Architect acceptance; this local Sprint does not claim delivery or ratification.
